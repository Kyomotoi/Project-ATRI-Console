		...
		<v-card flat>
			...
			<v-container>
				<v-row>
					<v-card flat class="mx-auto">
						连接状态:
						<v-chip class="ma-2" :color="stat_co" text-color="white">{{ stat_str }}</v-chip>
					</v-card>

					<v-card flat class="mx-auto">
						状态信息:
						<v-chip class="ma-2" :color="stat_msg_co" outlined>
			...
			<v-container>
				<v-row>
					<v-card flat class="mx-auto">
						总消息-收:
						<v-chip class="ma-2" color="#65cf38" outlined>
					...
					<v-card flat class="mx-auto">
						总消息-处理:
						<v-chip class="ma-2" color="#e8b51c" outlined>
					...
					<v-card flat class="mx-auto">
						处理失败:
						<v-chip class="ma-2" color="#e81c1c" outlined>
